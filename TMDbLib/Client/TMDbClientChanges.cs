...
namespace TMDbLib.Client
{
    ...
    {
        private async Task<T> GetChanges<T>(string type, int page = 0, int? id = 0, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default)
        {
            string resource;
            if (id.HasValue)
        ...
        {
            return await GetChanges<SearchContainer<ChangesListItem>>("movie", page, startDate: startDate, endDate: endDate, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await GetChanges<SearchContainer<ChangesListItem>>("person", page, startDate: startDate, endDate: endDate, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return await GetChanges<SearchContainer<ChangesListItem>>("tv", page, startDate: startDate, endDate: endDate, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            ChangesContainer changesContainer = await GetChanges<ChangesContainer>("movie", page, movieId, startDate, endDate, cancellationToken);
        ...
        {
            ChangesContainer changesContainer = await GetChanges<ChangesContainer>("person", page, personId, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return changesContainer.Changes;
        }
        ...
        {
            ChangesContainer changesContainer = await GetChanges<ChangesContainer>("tv/season", page, seasonId, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return changesContainer.Changes;
        }
        ...
        {
            ChangesContainer changesContainer = await GetChanges<ChangesContainer>("tv/episode", page, episodeId, startDate, endDate, cancellationToken).ConfigureAwait(false);
            return changesContainer.Changes;
        }
    }
}